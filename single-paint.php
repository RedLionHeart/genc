        ...
        <div class="info-card">
            ...
            <div class="documentation">
                <?php if (is_user_role('tds') || is_user_role('msds') || is_user_role('administrator')): ?>
                    ...
                    <?php if ($tds): ?>
                        <a download href="<?= $tds ?>" class="button-download mb-16 button-download-disabled">
                            <div class="tds">
